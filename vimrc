...
set wildignore=.git,*.py[co],*.class,*.obj,*.o,*.so,*.hi,tags,**/cache*/*,**/logs/*,**/target*/*,**/dist/*,**/node_modules/*,**/build/*,**/i18n/*,**/locale/*,**/compiled/*,**/__tests__/*
...
function! s:SetupEnvironment()
  let l:path = expand('%:p')
  if l:path =~ '/Volumes/data/dev/foyer-sammy-front'
    setlocal tabstop=4
